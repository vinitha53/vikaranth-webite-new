...
export default function FloatingIconDock() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(([entry]) => {
      ...
      if (entry.isIntersecting) setChatOpen(false);
    }, { threshold: 0.02 });
  ...
  return (
    <>
      <div className={`floating-site-dock floating-site-dock-left${footerVisible ? " floating-site-dock-hidden" : ""}`} role="navigation" aria-label="Social media" aria-hidden={footerVisible || undefined} inert={footerVisible ? "" : undefined}>
      ...
      <div className={`floating-site-dock floating-site-dock-right${footerVisible ? " floating-site-dock-hidden" : ""}`} role="navigation" aria-label="Quick contact" aria-hidden={footerVisible || undefined} inert={footerVisible ? "" : undefined}>
