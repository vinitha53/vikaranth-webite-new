...
export function DetailFooter() {
  return <>
    ...
    <footer className={styles.footer}>
      <div><Image src="/logo-vikranth.png" width={160} height={62} alt="Vikranth Chemical Corporation"/><p>Vikranth Chemical Corporation supplies bakery, chocolate, dairy, beverage and specialty food ingredients to manufacturers and professional buyers from Chennai, India.</p></div>
