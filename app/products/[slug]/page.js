...
export default async function ProductPage({ params }) {
  ...
  return <main className={styles.page} data-product-page data-whatsapp-number={whatsappNumber}>
    ...
    <section className={styles.hero} data-hero><div className={styles.heroGlow} data-depth /><div className={styles.wrap}>
      ...
      {product.name !== "Vital Wheat Gluten" && <div className={`${styles.partnerPanel} ${showProductBrand ? styles.partnerPanelWithBrand : ""}`} data-partner-badge><span>{showProductBrand ? "Product brand & supplier" : productPartners.length ? "Verified product partner" : "Sourcing contact"}</span><div className={styles.partnerLogos}>
