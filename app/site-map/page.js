...
import { corePages, industryPages, partnerPages, productPages, rangePages } from "../data/site-urls";
...
const groups = [
  ...
  { title: "MEC3 Specialist Ranges", description: "Gelato and dessert ranges with catalogue pack information.", links: rangePages },
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.content}>
        <div className={styles.summary}><strong>{groups.reduce((total, group) => total + group.links.length, 0)}</strong><span>pages to explore</span><p>Serving food businesses in Chennai, Tamil Nadu, South India and across India.</p></div>
