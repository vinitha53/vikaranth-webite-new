...
export const aboutProcess = [
  ["Define the requirement", "Share the ingredient or application, required function, approximate quantity and delivery location."],
  ["Confirm product and grade", "Review relevant product, manufacturer, grade and application information."],
  ["Check packs and documents", "Confirm available pack sizes, commercial quantities and COA, TDS, SDS or specifications where available."],
  ["Coordinate the next step", "Proceed with quotation, delivery planning and accurate identification for repeat requirements."]
];
